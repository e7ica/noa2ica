...
namespace App\Hidrator\More;

use App\Domain\More\Inspector;
use App\Domain\More\Response\Answer\AnswerAttachment;
use App\Domain\More\Response\Answer\AnswerChoice;
use App\Domain\More\Response\Answer\AnswerField;
use App\Domain\More\Response\Answer\ControlAnswer;
use App\Domain\More\Response\InspectionResponse;
...
class ResponseHydrator
{
    ...
    private function createInspectionResponse(array $data): InspectionResponse
    {
        ...
        $answers = array_map(function($answerData) {
            ...
            # a public common url  get of symfony config
